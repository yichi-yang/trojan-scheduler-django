...
from .views import UserView, EmailSendTokenView, EmailVerificationView, TokenInvalidateView
...
urlpatterns = [
    ...
    path('token/invalidate/', TokenInvalidateView.as_view(), name='token_invalidate'),
